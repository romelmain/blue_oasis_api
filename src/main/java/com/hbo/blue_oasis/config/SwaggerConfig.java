...
@OpenAPIDefinition(info = @Info(title = "BLUE OASIS API", description = "BLUE OASIS API, allow create booking rooms, create check in and check out for the BLUE OASIS HOTEL", termsOfService = "www.aa.com/terminos_y_condiciones", version = "1.0.0", contact = @Contact(name = "Romel Herrera", url = "https://aa.com", email = "santy@mail.com"), license = @License(name = "Standard Software Use License for Romelxxx", url = "www.aaa.com/licence")), servers = {
